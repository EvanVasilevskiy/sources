...
//---------------------------------------------------------------------------
AnsiString __fastcall TSmartTest::GetUslRes2(struct viragenie* vir, AnsiString& izn, bool& estusl)
{
       if(!vir) return 0;
       ...
       while(1)
       {
		...
		if(bo == 3) zn += "zn != ";
	       ...
	       if(vir->sub)
	       {
		       ...
		       zn += val;
		       if(estusl2)
		       izn += IntToStr(vir->countsubtrue) + "   " + IntToStr(vir->countsubexec) + "   " + val + "\r\n";
...
//---------------------------------------------------------------------------
// Сумма дельт
float* __fastcall TSmartTest::DELTA(int count, struct candlesdata* cndls, struct timedaymonthyear_candles* tmdmy, int Period)
{
...
float* __fastcall TSmartTest::DIFFDELTA(int count, struct candlesdata* cndls, struct timedaymonthyear_candles* tmdmy, int Period)
{
        if(!cndls || count <= 0) return NULL;
	float* Out = (float*)malloc(sizeof(float)*count);
	ZeroMemory(Out, sizeof(float)*count);
...
float* __fastcall TSmartTest::DRAG(int count, struct candlesdata* cndls, struct timedaymonthyear_candles* tmdmy, int Period)
{
        if(!cndls || count <= 0) return NULL;
	float* Out = (float*)malloc(sizeof(float)*count);
	ZeroMemory(Out, sizeof(float)*count);
...
float* __fastcall TSmartTest::SMA(int count, struct candlesdata* cndls, struct timedaymonthyear_candles* tmdmy, int Period, AnsiString VType, AnsiString dayofweek)
{
        if(!cndls || count <= 0) return NULL;
	float* Out = (float*)malloc(sizeof(float)*count);
	ZeroMemory(Out, sizeof(float)*count);
...
float* __fastcall TSmartTest::EMA(int count, struct candlesdata* cndls, int Period, AnsiString VType)
{
        if(!cndls || count <= 0) return NULL;
	float* Out = (float*)malloc(sizeof(float)*count);
	ZeroMemory(Out, sizeof(float)*count);
...
float* __fastcall TSmartTest::MACDH(int count, struct candlesdata* cndls, int perfast, int perslow, AnsiString TypePrice, AnsiString Metod1, AnsiString Metod2, int persignal)
{
...
//------------------------------------------------------------------
float __fastcall TSmartTest::tSMA(int I, int Period, AnsiString VType, void* dt, AnsiString round)
{
	float Out = 0;
...
float __fastcall TSmartTest::tEMA(int I, int Period, AnsiString VType, void* dt, AnsiString round, float* EMA_TMP)
{
        float Out = 0;
...
float* __fastcall TSmartTest::RSI(int count, struct candlesdata* cndls, int Period, AnsiString VType, AnsiString round) //--Relative Strength I("RSI")
{
...
float __fastcall TSmartTest::tSD(int I, int Period, AnsiString VType, void* dt, AnsiString round, AnsiString Metod) //--Standard Deviation ("SD")
{
       float Out = 0;
       int P         = Period;
       AnsiString M  = Metod;
...
float* __fastcall TSmartTest::ATR(int count, struct candlesdata* cndls, int Period, AnsiString round) //--Average True Range ("ATR")
{
...
float* __fastcall TSmartTest::Extremums(int count, struct candlesdata* cndls, int Period, AnsiString round)
{
...
struct float_f3* __fastcall TSmartTest::PC(int count, struct candlesdata* cndls, int Period, AnsiString round)  //--Price Channel ("PC")
{
...
float* __fastcall TSmartTest::EDA(int count, struct candlesdata* cndls, int Period, AnsiString VType, AnsiString ABS, AnsiString round)
{
...
float* __fastcall TSmartTest::LocMin(int count, struct candlesdata* cndls, int Period, AnsiString VType, AnsiString round)
{
...
float* __fastcall TSmartTest::LocMax(int count, struct candlesdata* cndls, int Period, AnsiString VType, AnsiString round)
{
...
float* __fastcall TSmartTest::EAnews(int timeframe, int count, struct candlesdata* cndls, int Period, AnsiString TextSearch, AnsiString round)
{
...
float* __fastcall TSmartTest::ImpulseLightness(int count, struct candlesdata* cndls, AnsiString round)
{
